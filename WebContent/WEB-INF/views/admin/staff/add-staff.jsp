...
<body>
			...
			<div class="col-md ml-5">
				<div class="form-group my-3 text-center" data-plugin="formMaterial">
					<h3>
						...
						<s:message code="admin.staff.form.addtitle"/>
					</h3>
				</div>
				<form method="post" action="admin/staff/add-staff.htm"
						...
						<div class="col">
							<div class="form-group my-3" data-plugin="formMaterial">
								...
								<s:message code="admin.staff.table.col2"/>
									...
									id="inputText" name="id" placeholder="Text" required>
							</div>
							...
							<div class="form-group my-3" data-plugin="formMaterial">
								...
								<s:message code="admin.staff.table.col3"/>
									...
									id="inputFullname" name="name" placeholder="Text" required>
							</div>
							...
							<div class="form-group my-3" data-plugin="formMaterial">
								...
								<div class="form-check-inline">
									<label class="form-check-label" for="radio2"> <input
										...
										name="gender" value="true" checked>Nam (Male)
									</label>
								</div>
								<div class="form-check-inline">
									<label class="form-check-label" for="radio2"> <input
										type="radio" class="form-check-input" id="radio2"
										name="gender" value="false">Nữ (Female)
									</label>
								</div>
							</div>
							<div class="form-group my-3" data-plugin="formMaterial">
								...
								<input type="email" class="form-control validated" id="email"
									name="email" placeholder="Text" required>
							</div>
							<div class="form-group my-3" data-plugin="formMaterial">
							...
							<div class="form-group my-3" data-plugin="formMaterial">
								...
								<input type="number" class="form-control validated" id="salary"
									name="salary" placeholder="Text" required>
							</div>
						</div>
						<div class="col">
							<div class="form-group my-3" data-plugin="formMaterial">
								...
								<s:message code="admin.staff.table.col5"/>
									...
									id="datePicker" name="birthday" placeholder="Text" required>
							</div>
							...
							<div class="form-group">
								...
								<s:message code="admin.staff.table.col10"/>
								</label> <select
									class="form-control" name="departId" id="combobox">
									<c:forEach var="depart" items="${listDepart}">
										<option value="${depart.id.trim()}">${depart.name}</option>
									</c:forEach>
								</select>
							</div>
							<div class="input-group mb-3">
								...
								<div class="custom-file">
									<input type="hidden" id="photoName" name="photo"
										value="unknown-avatar.jpg"> <input type="file"
			...
			<div class="col-md w-30 h-100">
				<div class="my-3 align-center text-center">
					<img class="rounded my-5 mx-auto"
						src="resource/avatar/unknown-avatar.jpg" id="staffPhoto"
	...
	<script type="text/javascript">
		...
		bootstrapValidate('#salary', 'numeric|required:Enter number')
