...
<body>
	<div class="container-fluid d-flex justify-content-center">
		<div
			...
			<form method="post" action="admin/depart/add-depart.htm"
				...
				<div class="form-group my-3 text-center" data-plugin="formMaterial">
					<h3>
						<c:choose>
							<c:when test="${empty message}"><s:message code="admin.depart.form.addtitle"/></c:when>
				...
				<div class="form-group my-3" data-plugin="formMaterial">
					...
					<s:message code="admin.depart.table.col3"/>
						...
						id="inputDepartname" name="name" placeholder="Text" required>
				</div>
				...
				<button class="btn btn-primary mb-3 float-right" type="submit">
					<s:message code="admin.depart.form.addtitle"/>
				</button>
			</form>
		</div>
	</div>
